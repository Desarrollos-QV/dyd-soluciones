<nav class="sidebar">
    ...
    <div class="sidebar-body">
        <ul class="nav">
            ...
            @if(Auth::user() && (Auth::user()->role == 'admin' || Auth::user()->role == 'subadmin'))
                <li class="nav-item @if (Route::is('home') || Route::is('dashboard')) active @endif">
                    <a href="{{ url('./') }}" class="nav-link @if (Route::is('home') || Route::is('dashboard')) active @endif">
                        ...
                        <span class="link-title">Dashboard {{ Auth::user() ? Auth::user()->role : 'General' }}</span>
                    </a>
                </li>
            ...
            @elseif(Auth::user() && Auth::user()->role == 'tecnico')
                <li class="nav-item @if (Route::is('home') || Route::is('dashboard')) active @endif">
                    <a href="{{ url('./') }}" class="nav-link @if (Route::is('home') || Route::is('dashboard')) active @endif">
                        <i class="link-icon" data-feather="home"></i>
                        <span class="link-title">Dashboard {{ Auth::user() ? Auth::user()->role : 'General' }}</span>
            ...
            @elseif(Auth::guard('sellers')->check())
                <li class="nav-item @if (Route::is('sellers.dashboard')) active @endif">
                    <a href="{{ route('sellers.dashboard') }}" class="nav-link @if (Route::is('sellers.dashboard')) active @endif">
                        <i class="link-icon" data-feather="home"></i>
                        <span class="link-title">Dashboard</span>
                        <i class="link-arrow" data-feather="chevron-right"></i>
                    </a>
                </li>
                <li class="nav-item @if (Route::is('sellers.prospects.index') || Route::is('sellers.prospects.edit') || Route::is('sellers.prospects.create')) active @endif">
                    <a class="nav-link" href="{{ route('sellers.prospects.index') }}">
                        <i class="link-icon" data-feather="user-plus"></i>
                        <span class="link-title">Prospectos</span>
                        <i class="link-arrow" data-feather="chevron-right"></i>
                    </a>
                ...
                <li class="nav-item @if (Route::is('sellers.kanban.index')) active @endif">
                    <a class="nav-link" href="{{ route('sellers.kanban.index') }}">
                        <i class="link-icon" data-feather="user-plus"></i>
                        <span class="link-title">KanBan</span>
                        <i class="link-arrow" data-feather="chevron-right"></i>
                    </a>
