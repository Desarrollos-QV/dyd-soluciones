@extends('layouts.app') 
@section('title', 'Registrar nuevo movimiento')
@section('css')
...
<nav class="page-breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Registrar nuevo movimiento</li>
    </ol>
</nav>

<form action="{{ route('gastos.store') }}" method="POST" id="gastos_form" class="row" enctype="multipart/form-data">
    @csrf
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        const form = document.getElementById('gastos_form');
