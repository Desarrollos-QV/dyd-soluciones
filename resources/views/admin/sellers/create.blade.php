@extends('layouts.app') 
@section('title', 'Registrar nuevo vendedor')
@section('content')
<nav class="page-breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{ url('./') }}">Inicio</a></li>
        <li class="breadcrumb-item active" aria-current="page">Registrar nuevo vendedor</li>
    </ol>
</nav>

<form action="{{ route('sellers.store') }}" method="POST" id="sellers_form" class="row" enctype="multipart/form-data">
    @csrf
