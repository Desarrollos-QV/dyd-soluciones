                ...
                <div class="row">
                    <div class="col-lg-12">
                        <label for="tools" class="d-flex align-items-center justify-content-between">
                            ...
                            <button type="button" class="btn btn-sm btn-outline-primary" onclick="addTools()">+
                                Añadir
                                herramienta</button>
                        </label>
                        <div id="repuestos-list">
                            @php
                                $ref = old('tools', json_decode($tecnico->tools, true) ?? null);
                            @endphp
                        ...
                        @if (isset($tecnico->id))
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4"
                                    ...
                                    <img src="{{ asset($tecnico->avatar) }}" alt="avatar"
                    ...
                    <div class="col-md-12 mt-4">
                        @if (isset($tecnico->id))
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4"
                                    style="display: flex;justify-content: center;align-items: center;">
                                    <img src="{{ asset($tecnico->identificacion) }}" alt="identificacion"
                                        style="width:100px;height: 100px;border-radius: 25px;">
                                </div>
                            </div>
                        @else
