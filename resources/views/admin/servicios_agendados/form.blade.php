            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="tipo_vehiculo" id="tipo_vehiculo" class="form-control" disabled
                            value="{{ $servicio->tipo_vehiculo }}">
                    </div>
                    <div class="col-md-6">
                        <label for="marca">Marca</label>
                        <input type="text" name="marca" class="form-control" id="marca" disabled
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="dispositivo_instalado" id="dispositivo_instalado" class="form-control"
                            disabled value="{{ $servicio->unidad['dispositivo_instalado'] }}">
                    </div>
                    <div class="col-md-3">
